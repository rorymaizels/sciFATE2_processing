#!/bin/bash
#SBATCH --job-name=scp1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --time=12:00:00
#SBATCH --mem=100G
#SBATCH --partition=cpu
#SBATCH --output=sp1_main.out

SAMPLE="1_QC1_1"

### 0. DEFINE GLOBAL PARAMETERS
python_path="/camp/lab/briscoej/working/Rory/.conda2/my_envs/python_lab/bin"
home="/camp/lab/briscoej/working/Rory/transcriptomics/sciFATE_data/pilots/SCI_PILOT1"
excel="PM20195.xlsx"
...
STAR="/camp/lab/briscoej/working/Rory/transcriptomics/sciFATE_data/experiments/STAR"
...
sbatch $scripts/array_scifate.sh $STAR $GTF $home $fastq $data_dir $meta_dir $dmpx_write $scripts $sample_csv_name $python_path $p_e $snv_csv $trim_cutoff $do_estimate $est_method
